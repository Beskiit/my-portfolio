    ...
    <section id="hero" className="flex flex-col items-center mt-20 gap-2 px-4">
      <div className="flex flex-col items-center lg:flex-row-reverse lg:justify-center lg:w-full lg:px-10 gap-10">
        ...
        <div className="text-center lg:text-start lg:flex lg:flex-col lg:gap-10">
          <div className="">
            <h1 className="text-2xl font-bold mb-2 text-black md:text-3xl lg:text-5xl">
              Hi, I&apos;m Airone Gamil
            </h1>
            <p className="text-lg font-semibold mb-4 text-black md:text-xl lg:text-3xl">
              Your Software Developer
            </p>
          </div>
          <p className="text-center max-w-xl text-black text-sm md:text-lg lg:text-2xl lg:text-start">
            I build modern, scalable web applications designed to solve
            real-world problems through clean architecture, efficient
          ...
          <div className="flex flex-row justify-center items-center gap-2 mt-2 lg:gap-4">
            ...
            <div className="flex flex-row gap-1 items-center text-black lg:gap-4">
              <Mail className="md:h-6 md:w-6" />
              <a
                href="mailto:aironegamil123@gmail.com"
                className="text-[0.725rem] font-semibold md:text-sm"
              >
